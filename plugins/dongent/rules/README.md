...
| Folder | Tier | Summary |
|---|---|---|
| [`markdown-convention/`][markdown-convention/] | recommended | Markdown mechanics: prettier-ignore + compact tables, Markdown-syntax links, reference-style References section |
