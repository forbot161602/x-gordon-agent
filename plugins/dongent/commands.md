...
| [`/dongent:compact-checkpoint`][commands/compact-checkpoint.md] | Before compaction or context loss, capture durable session state into the project's agent memory so it survives into future sessions. Write-side. |
