...
- **Helper** — scripts, templates, fixtures are lowercase; pair any logic-carrying file with a test (e.g. `helper.py` and `helper_test.py`) so its behaviour stays verifiable.
